...
pd = [(1, 0.301), (2, 0.176), (3, 0.125), (4, 0.097), (5, 0.079), (6, 0.067), (7, 0.058), (8, 0.051), (9, 0.046),]
# а)  для чисел Фибоначчи
n = 500
fib_list = [1, 1]
p_list = [0] * 9
...
for i in fib_list:
    str_d = str(i)
    p_list[int(str_d[0]) - 1] += 1

for i, d in enumerate(p_list):
    p_list[i] = d / n

z = zip(range(1, 10), p_list)

for d, p in z:
    print(f"{d:d}\t{p:.3f}\t{p - pd[d - 1][1]:6.3f}")
...
# б) для длины последовательности аминокислот
